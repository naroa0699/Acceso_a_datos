...
public class FicheroAccesoAleatorio {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            reg.put("NOMBRE", "PRUEBA");
            reg.put("CP", "00000");

            System.out.println("Número de registros inicial: " + faa.getNumReg());
            faa.insertar(reg); // Inserta el primero
            System.out.println("Número de registros después de insertar 1: " + faa.getNumReg());

            // Intenta escribir en la posición 10 (cuando solo hay 1)
            faa.insertar(reg, 10L);
            System.out.println("Número de registros tras escribir en posición 10: " + faa.getNumReg());
        } catch (IOException e) {
